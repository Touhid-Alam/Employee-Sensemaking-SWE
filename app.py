...
st.markdown("""
    ...
    .survey-question p {
        font-size: 18px !important; /* CHANGED FROM 24px TO 18px */
    ...
    # --- PAGE 3: SURVEY ---
        ...
        with c2:
            ...
            with st.form("survey"):
                ...
                st.markdown("---")
                final_submit = st.form_submit_button("Submit Final Data & Finish")
            ...
            if final_submit:
                ...
                if save_to_google_sheets(row):
                    ...
                    st.error("❌ Connection Error. Please try submitting again.")
    ...
    # --- PAGE 4: THANK YOU ---
        ...
        with c2:
            ...
            <div class="thank-you-card">
                <h1 style="color: #16a34a; font-size: 48px; margin-bottom: 20px;">✓ Complete!</h1>
                <h2 style="color: #334155;">Thank you for participating.</h2>
                <p style="font-size: 18px; color: #64748b; margin-top: 20px;">
                    Your data has been securely uploaded to the ELITE Research Database.
                </p>
                <br>
                ...
                <br><br>
                <p style="font-size: 14px; color: #94a3b8;">You may now close this browser tab.</p>
            </div>
            """.format(st.session_state.participant_id), unsafe_allow_html=True)
